...
let bodyLockStatus$1 = true;
let bodyLockToggle$1 = (delay = 500) => {
...
let bodyUnlock = (delay = 500) => {
  if (bodyLockStatus$1) {
    ...
    bodyLockStatus$1 = false;
    setTimeout(function() {
      bodyLockStatus$1 = true;
    }, delay);
  }
};
...
class Popup {
  ...
  close(selectorValue) {
    ...
    if (!this.isOpen || !bodyLockStatus$1) {
      return;
    }
...
function menuInit$1() {
  document.addEventListener("click", function(e) {
    if (bodyLockStatus$1 && e.target.closest("[data-fls-menu]")) {
      bodyLockToggle$1();
