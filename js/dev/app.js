...
function initSliders() {
  ...
  if (document.querySelector(".cars__slider")) {
  ...
  if (document.querySelector(".calculator__slider")) {
    new Swiper(".calculator__slider", {
      ...
      navigation: {
        prevEl: ".calculator__prev",
        nextEl: ".calculator__next"
      },
      pagination: {
      ...
      on: {
        init: function(swiper2) {
          ...
          const progressBarFill = document.querySelector(".calculator__progress-bar span");
          if (progressText) {
            progressText.textContent = `Шаг 1 из ${totalSlides}`;
          }
          if (progressBarFill) {
        ...
        slideChange: function(swiper2) {
          const currentIndex = swiper2.realIndex + 1;
          const totalSlides = swiper2.slides.length;
          const progress = (currentIndex - 1) / (totalSlides - 1) * 100;
          const progressText = document.querySelector(".calculator__progress-text");
          if (progressText) {
            progressText.textContent = `Шаг ${currentIndex} из ${totalSlides}`;
          }
          const progressBarFill = document.querySelector(".calculator__progress-bar span");
          if (progressBarFill) {
        ...
        reachEnd: function(swiper2) {
          console.log("Калькулятор завершён");
        }
      }
    });
  }
